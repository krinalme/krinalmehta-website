    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="content-section prose" style={{ padding: 'var(--space-lg) var(--space-md)', maxWidth: 'var(--max-width-prose)', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.05rem', color: 'var(--color-ink-light)', lineHeight: 1.8 }}>Today, I lead growth across Bluehost, HostGator, and Yoast at Newfold Digital, a portfolio of brands that powers millions of websites worldwide. Before that, I spent four years at FreshBooks scaling organic from the #3 revenue channel to #1, contributing $30M in ARR.</p>
        </section>
        ...
        <section style={{ padding: 'var(--space-xl) var(--space-md)', background: 'var(--color-ink)', color: 'var(--color-paper)' }}>
          <div style={{ maxWidth: 'var(--max-width-prose)', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1.05rem', lineHeight: 1.8, opacity: 0.8 }}>I'm also a perpetual teacher. I've been a Lead Instructor at BrainStation, a trainer for IAB Canada, and I regularly speak at industry events and webinars. I believe the best way to learn is to teach, and the best way to stay sharp is to share what you know.</p>
          </div>
        </section>
        ...
        <section style={{ padding: 'var(--space-xl) var(--space-md)', textAlign: 'center' }}>
          <div style={{ maxWidth: 'var(--max-width-prose)', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--color-ink-light)', marginBottom: 'var(--space-md)' }}>I'm always interested in connecting with fellow growth leaders, founders building interesting companies, and anyone thinking deeply about the future of search and AI.</p>
